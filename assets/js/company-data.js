...
var COMPANY_DATA = (function () {
  ...
  var META = {
    ...
    legalPage: {
      tocTitle:         { en: 'Contents', ar: 'المحتويات' },
      lastUpdatedLabel: { en: 'Last updated', ar: 'آخر تحديث' },
      appliesTo:        { en: 'Applies to', ar: 'ينطبق على' },
      legalBadge:       { en: 'Legal', ar: 'قانوني' },

      privacy: {
        title: { en: 'Privacy Policy', ar: 'سياسة الخصوصية' },
        introNote: {
          en: 'This Privacy Policy describes how Firdaws Import & Export Co. (\u201Cwe\u201D, \u201Cus\u201D, or \u201Cour\u201D) collects, uses, and protects information when you visit or interact with our website at firdawsco.com. By using our website, you agree to the practices described in this policy.',
          ar: 'توضح سياسة الخصوصية هذه كيفية قيام مؤسسة الفردوس للاستيراد والتصدير (\u201Cنحن\u201D أو \u201Cلنا\u201D أو \u201Cخاصتنا\u201D) بجمع واستخدام وحماية المعلومات عند زيارتكم أو تفاعلكم مع موقعنا الإلكتروني firdawsco.com. باستخدامكم لموقعنا، فإنكم توافقون على الممارسات الموصوفة في هذه السياسة.'
        },
        sections: [
          {
            id: 'overview',
            en: { heading: 'Overview', content: 'We operate a static corporate website designed for B2B (business-to-business) agricultural export inquiries. Our website does not require user registration, login accounts, or online payments. All business inquiries are handled through WhatsApp, phone, or email communication channels. We are committed to collecting only the minimum information necessary to respond to your trade inquiries.' },
            ar: { heading: 'نظرة عامة', content: 'نشغّل موقعاً إلكترونياً ثابتاً مصمماً لاستفسارات التصدير الزراعي بين الشركات (B2B). لا يتطلب موقعنا تسجيل مستخدمين أو حسابات دخول أو مدفوعات إلكترونية. يتم التعامل مع جميع الاستفسارات التجارية عبر واتساب أو الهاتف أو البريد الإلكتروني. نلتزم بجمع الحد الأدنى فقط من المعلومات اللازمة للرد على استفساراتكم التجارية.' }
          },
          {
            id: 'data-collected',
            en: { heading: 'Information We Collect', content: 'When you use our contact form, you may voluntarily provide your name, email address, company name, country, product of interest, and a message. This information is not stored on our servers \u2014 it is formatted and sent directly to our WhatsApp business number for our team to respond. We do not store, process, or retain any form submission data on our website or any connected database. Standard server logs may be generated by our hosting provider (GitHub Pages via Cloudflare) and may include IP addresses, browser type, pages visited, and timestamps. These logs are handled according to GitHub and Cloudflare privacy policies and are not accessed by us for profiling purposes.' },
            ar: { heading: 'المعلومات التي نجمعها', content: 'عند استخدامكم نموذج التواصل، قد تقدمون طوعياً اسمكم وبريدكم الإلكتروني واسم شركتكم وبلدكم والمنتج المطلوب ورسالتكم. لا تُخزن هذه المعلومات على خوادمنا \u2014 بل تُنسّق وتُرسل مباشرة إلى رقم واتساب الأعمال الخاص بنا ليتمكن فريقنا من الرد. لا نخزّن أو نعالج أو نحتفظ بأي بيانات نموذج على موقعنا أو أي قاعدة بيانات متصلة. قد تُنشأ سجلات خادم قياسية من قبل مزود الاستضافة (GitHub Pages عبر Cloudflare) وقد تتضمن عناوين IP ونوع المتصفح والصفحات المزارة والطوابع الزمنية. تُعالج هذه السجلات وفقاً لسياسات خصوصية GitHub و Cloudflare ولا نصل إليها لأغراض التنميط.' }
          },
          {
            id: 'data-not-collected',
            en: { heading: 'Information We Do Not Collect', content: 'We do not collect payment information, credit card details, or banking data. We do not use cookies for tracking or analytics. We do not use analytics services such as Google Analytics. We do not use advertising pixels or retargeting services. We do not require user accounts or passwords. We store the user\u2019s language preference in localStorage for bilingual switching convenience \u2014 this contains no personal information.' },
            ar: { heading: 'معلومات لا نجمعها', content: 'لا نجمع معلومات الدفع أو تفاصيل بطاقات الائتمان أو البيانات المصرفية. لا نستخدم ملفات تعريف الارتباط (كوكيز) للتتبع أو التحليلات. لا نستخدم خدمات تحليلات مثل Google Analytics. لا نستخدم بيكسلات إعلانية أو خدمات إعادة استهداف. لا نتطلب حسابات مستخدمين أو كلمات مرور. نحفظ تفضيل لغة المستخدم في localStorage لسهولة تبديل اللغات \u2014 وهذا لا يحتوي على أي معلومات شخصية.' }
          },
          {
            id: 'how-used',
            en: { heading: 'How We Use Information', content: 'The information you provide through our contact form is used solely to respond to your trade inquiry via WhatsApp. Your product interest selection helps our export team prepare relevant quotations. We do not use your information for marketing campaigns, email newsletters, or any automated processing.' },
            ar: { heading: 'كيف نستخدم المعلومات', content: 'تُستخدم المعلومات التي تقدمونها عبر نموذج التواصل فقط للرد على استفساركم التجاري عبر واتساب. يساعد اختياركم للمنتج فريق التصدير لدينا في إعداد عروض الأسعار ذات الصلة. لا نستخدم معلوماتكم في حملات تسويقية أو نشرات إخبارية بالبريد الإلكتروني أو أي معالجة آلية.' }
          },
          {
            id: 'third-parties',
            en: { heading: 'Third-Party Services', content: 'Our website uses a limited set of third-party services: GitHub Pages for static site hosting, Cloudflare for DNS and CDN services, and WhatsApp (Meta Platforms) for business communication initiated by visitors. All third-party services are used in their minimum-data-collection capacity. We do not share your personal data with any third party beyond what is technically necessary for website operation and inquiry handling.' },
            ar: { heading: 'خدمات الطرف الثالث', content: 'يستخدم موقعنا مجموعة محدودة من خدمات الطرف الثالث: GitHub Pages لاستضافة الموقع الثابت، Cloudflare لخدمات DNS و CDN، وواتساب (Meta Platforms) للتواصل التجاري الذي يبدأه الزوار. تُستخدم جميع خدمات الطرف الثالث بأقل قدر من جمع البيانات. لا نشارك بياناتكم الشخصية مع أي طرف ثالث بخلاف ما هو ضروري تقنياً لتشغيل الموقع ومعالجة الاستفسارات.' }
          },
          {
            id: 'security',
            en: { heading: 'Security Measures', content: 'All traffic is served exclusively over HTTPS, enforced by Cloudflare. A strict Content Security Policy (CSP) is applied to every page, preventing code injection attacks. All dynamic content is built using DOM API \u2014 no user data is injected as raw HTML, eliminating XSS vulnerabilities. No user data is stored on the website \u2014 the contact form redirects to WhatsApp without server-side processing.' },
            ar: { heading: 'إجراءات الأمان', content: 'تُقدم كل حركة المرور حصرياً عبر HTTPS، مفروضة من Cloudflare. تُطبق سياسة أمان محتوى صارمة (CSP) على كل صفحة، مما يمنع هجمات حقن الكود. يُبنى كل المحتوى الديناميكي باستخدام DOM API \u2014 لا تُحقن بيانات المستخدم كـ HTML خام، مما يزيل ثغرات XSS. لا تُخزن بيانات المستخدم على الموقع \u2014 نموذج التواصل يوجه إلى واتساب بدون معالجة من جانب الخادم.' }
          },
          {
            id: 'rights',
            en: { heading: 'Your Rights', content: 'Since we do not store personal data on our systems, most traditional data rights (access, rectification, erasure) do not apply in a conventional sense. However, if you have communicated with us via WhatsApp or email and wish to request deletion of those communications from our devices, you may contact us and we will accommodate your request within 30 days. WhatsApp messages are also governed by WhatsApp\u2019s own retention policies.' },
            ar: { heading: 'حقوقكم', content: 'نظراً لأننا لا نخزن بيانات شخصية على أنظمتنا، فإن معظم حقوق البيانات التقليدية (الوصول والتصحيح والمسح) لا تنطبق بالمعنى التقليدي. ومع ذلك، إذا تواصلتم معنا عبر واتساب أو البريد الإلكتروني وترغبون في طلب حذف تلك المراسلات من أجهزتنا، يمكنكم التواصل معنا وسنلبي طلبكم خلال ٣٠ يوماً. تخضع رسائل واتساب أيضاً لسياسات الاحتفاظ الخاصة بواتساب.' }
          },
          {
            id: 'children',
            en: { heading: 'Children\u2019s Privacy', content: 'Our website is a B2B platform for international agricultural trade and is not directed at children under the age of 18. We do not knowingly collect information from minors.' },
            ar: { heading: 'خصوصية الأطفال', content: 'موقعنا منصة B2B للتجارة الزراعية الدولية وليس موجهاً للأطفال تحت سن ١٨ عاماً. لا نجمع معلومات من القاصرين عن علم.' }
          },
          {
            id: 'changes',
            en: { heading: 'Changes to This Policy', content: 'We may update this Privacy Policy from time to time. When we make changes, we will update the \u201CLast updated\u201D date at the top of this page. Continued use of the website after a policy update constitutes acceptance of the revised terms.' },
            ar: { heading: 'تغييرات على هذه السياسة', content: 'قد نحدّث سياسة الخصوصية هذه من وقت لآخر. عند إجراء تغييرات، سنحدّث تاريخ \u201Cآخر تحديث\u201D في أعلى هذه الصفحة. يشكّل الاستمرار في استخدام الموقع بعد تحديث السياسة قبولاً للشروط المعدّلة.' }
          },
          {
            id: 'contact',
            en: { heading: 'Contact Us', content: 'If you have any questions or concerns regarding this Privacy Policy, please contact us.' },
            ar: { heading: 'تواصل معنا', content: 'إذا كانت لديكم أي أسئلة أو مخاوف بشأن سياسة الخصوصية هذه، يرجى التواصل معنا.' }
          }
        ]
      },
      ...
      terms: {
        ...
        introNote: {
          en: 'These Terms of Use govern your access to and use of the Firdaws Import & Export Co. website at firdawsco.com. By accessing or using our website, you agree to be bound by these terms.',
          ar: 'تحكم شروط الاستخدام هذه وصولكم إلى واستخدامكم لموقع مؤسسة الفردوس للاستيراد والتصدير على firdawsco.com. بالوصول إلى موقعنا أو استخدامه، فإنكم توافقون على الالتزام بهذه الشروط.'
        },
        sections: [
          {
            id: 'acceptance',
            en: { heading: 'Acceptance of Terms', content: 'By accessing and using this website, you acknowledge that you have read, understood, and agree to be bound by these Terms of Use. If you do not agree with any part of these terms, you should not use this website. These terms apply to all visitors, users, and others who access or use the website.' },
            ar: { heading: 'قبول الشروط', content: 'بالوصول إلى هذا الموقع واستخدامه، تقرون بأنكم قد قرأتم وفهمتم ووافقتم على الالتزام بشروط الاستخدام هذه. إذا لم توافقوا على أي جزء من هذه الشروط، يجب عليكم عدم استخدام هذا الموقع. تنطبق هذه الشروط على جميع الزوار والمستخدمين وغيرهم ممن يصلون إلى الموقع أو يستخدمونه.' }
          },
          {
            id: 'website-purpose',
            en: { heading: 'Website Purpose', content: 'This website serves as an informational platform for Firdaws Import & Export Co., an Egyptian agricultural export company. The website provides information about our products, certifications, and services. It is designed for B2B (business-to-business) use by international importers, distributors, and trade partners. The website does not facilitate online sales, payments, or order processing. All trade inquiries and transactions are conducted through direct communication via WhatsApp, phone, or email.' },
            ar: { heading: 'الغرض من الموقع', content: 'يعمل هذا الموقع كمنصة معلوماتية لمؤسسة الفردوس للاستيراد والتصدير، وهي شركة مصرية لتصدير المنتجات الزراعية. يوفر الموقع معلومات عن منتجاتنا وشهاداتنا وخدماتنا. وهو مصمم للاستخدام بين الشركات (B2B) من قبل المستوردين والموزعين والشركاء التجاريين الدوليين. لا يتيح الموقع المبيعات الإلكترونية أو المدفوعات أو معالجة الطلبات. تتم جميع الاستفسارات والمعاملات التجارية من خلال التواصل المباشر عبر واتساب أو الهاتف أو البريد الإلكتروني.' }
          },
          {
            id: 'product-information',
            en: { heading: 'Product Information', content: 'Product descriptions, specifications, images, season calendars, and packaging options displayed on this website are provided for informational purposes only and do not constitute a binding offer. Actual product specifications, availability, pricing, and minimum order quantities may vary and are subject to confirmation at the time of inquiry. Seasonal availability is approximate and may be affected by weather conditions, crop yields, and other agricultural factors. We make reasonable efforts to keep product information accurate and up to date, but we do not warrant its completeness or accuracy at all times.' },
            ar: { heading: 'معلومات المنتجات', content: 'أوصاف المنتجات والمواصفات والصور وتقاويم المواسم وخيارات التعبئة المعروضة على هذا الموقع مقدمة لأغراض إعلامية فقط ولا تشكل عرضاً ملزماً. قد تختلف مواصفات المنتجات الفعلية والتوافر والأسعار والحد الأدنى لكميات الطلب وتخضع للتأكيد وقت الاستفسار. التوافر الموسمي تقريبي وقد يتأثر بالظروف الجوية ومحاصيل الزراعة وعوامل زراعية أخرى. نبذل جهوداً معقولة للحفاظ على دقة معلومات المنتجات وتحديثها، لكننا لا نضمن اكتمالها أو دقتها في جميع الأوقات.' }
          },
          {
            id: 'intellectual-property',
            en: { heading: 'Intellectual Property', content: 'All content on this website, including but not limited to text, images, logos, graphics, product descriptions, and website design, is the property of Firdaws Import & Export Co. or its content suppliers and is protected by applicable intellectual property laws. You may not reproduce, distribute, modify, or create derivative works from any content on this website without our prior written consent. You may view and print pages from this website for your own personal, non-commercial use, provided you do not modify the content and you retain all copyright and proprietary notices.' },
            ar: { heading: 'الملكية الفكرية', content: 'جميع المحتوى على هذا الموقع، بما في ذلك على سبيل المثال لا الحصر النصوص والصور والشعارات والرسومات ووصف المنتجات وتصميم الموقع، هو ملك لمؤسسة الفردوس للاستيراد والتصدير أو موردي محتواها ومحمي بموجب قوانين الملكية الفكرية المعمول بها. لا يجوز لكم إعادة إنتاج أو توزيع أو تعديل أو إنشاء أعمال مشتقة من أي محتوى على هذا الموقع دون موافقتنا الخطية المسبقة. يمكنكم عرض وطباعة صفحات من هذا الموقع لاستخدامكم الشخصي غير التجاري، شريطة عدم تعديل المحتوى والاحتفاظ بجميع إشعارات حقوق النشر والملكية.' }
          },
          {
            id: 'trade-terms',
            en: { heading: 'Trade & Export Terms', content: 'All export transactions are subject to separate commercial agreements negotiated directly between Firdaws Import & Export Co. and the buyer. Pricing, payment terms, shipping arrangements, and delivery schedules are agreed upon individually for each transaction. International trade terms (Incoterms) applicable to specific shipments will be specified in the relevant commercial agreement. All transactions are subject to applicable Egyptian export regulations and international trade laws.' },
            ar: { heading: 'شروط التجارة والتصدير', content: 'تخضع جميع معاملات التصدير لاتفاقيات تجارية منفصلة يتم التفاوض عليها مباشرة بين مؤسسة الفردوس للاستيراد والتصدير والمشتري. يتم الاتفاق على الأسعار وشروط الدفع وترتيبات الشحن وجداول التسليم بشكل فردي لكل معاملة. تُحدد شروط التجارة الدولية (Incoterms) المطبقة على الشحنات المحددة في الاتفاقية التجارية ذات الصلة. تخضع جميع المعاملات للوائح التصدير المصرية المعمول بها وقوانين التجارة الدولية.' }
          },
          {
            id: 'disclaimer',
            en: { heading: 'Disclaimer of Warranties', content: 'This website is provided on an \u201Cas is\u201D and \u201Cas available\u201D basis. We make no warranties, expressed or implied, regarding the operation of the website, the accuracy of the information provided, or the suitability of products described herein for any particular purpose. We shall not be liable for any direct, indirect, incidental, special, or consequential damages arising from your use of this website or your reliance on any information provided herein.' },
            ar: { heading: 'إخلاء المسؤولية', content: 'يُقدم هذا الموقع \u201Cكما هو\u201D و\u201Cكما هو متاح\u201D. لا نقدم أي ضمانات، صريحة أو ضمنية، بشأن تشغيل الموقع أو دقة المعلومات المقدمة أو ملاءمة المنتجات الموصوفة هنا لأي غرض معين. لا نتحمل المسؤولية عن أي أضرار مباشرة أو غير مباشرة أو عرضية أو خاصة أو تبعية ناشئة عن استخدامكم لهذا الموقع أو اعتمادكم على أي معلومات مقدمة فيه.' }
          },
          {
            id: 'governing-law',
            en: { heading: 'Governing Law', content: 'These Terms of Use shall be governed by and construed in accordance with the laws of the Arab Republic of Egypt. Any disputes arising from or related to the use of this website shall be subject to the exclusive jurisdiction of the competent courts in Tanta, Gharbia Governorate, Egypt.' },
            ar: { heading: 'القانون الحاكم', content: 'تخضع شروط الاستخدام هذه وتُفسر وفقاً لقوانين جمهورية مصر العربية. تخضع أي نزاعات ناشئة عن أو متعلقة باستخدام هذا الموقع للاختصاص القضائي الحصري للمحاكم المختصة في طنطا، محافظة الغربية، مصر.' }
          },
          {
            id: 'changes',
            en: { heading: 'Changes to These Terms', content: 'We reserve the right to modify these Terms of Use at any time. Changes will be effective immediately upon posting to this page with an updated \u201CLast updated\u201D date. Your continued use of the website after any changes constitutes acceptance of the new terms.' },
            ar: { heading: 'تغييرات على هذه الشروط', content: 'نحتفظ بالحق في تعديل شروط الاستخدام هذه في أي وقت. تصبح التغييرات سارية فور نشرها على هذه الصفحة مع تحديث تاريخ \u201Cآخر تحديث\u201D. يشكل استمراركم في استخدام الموقع بعد أي تغييرات قبولاً للشروط الجديدة.' }
          },
          {
            id: 'contact',
            en: { heading: 'Contact Us', content: 'If you have any questions about these Terms of Use, please contact us.' },
            ar: { heading: 'تواصل معنا', content: 'إذا كانت لديكم أي أسئلة حول شروط الاستخدام هذه، يرجى التواصل معنا.' }
          }
        ]
      }
    }
